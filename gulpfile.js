...
* Licensed under MIT (https://github.com/alifewellplayed/Undertasker/blob/master/LICENSE)
*/
...
gulp.task('github-deploy', function () {
  ...
  .pipe($.ghPages({
    remoteUrl: 'https://github.com/alifewellplayed/gmachina.org.git',
    branch: 'gh-pages'
  }));
});
...
gulp.task('deploy', function() {
  ...
  .pipe(git({
    repository: 'https://github.com/alifewellplayed/gmachina.org.git',
    branches:   ['gh-pages'],
